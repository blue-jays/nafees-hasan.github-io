...
const StatisticalDataAnalysis = () => {
  ...
  const statisticalProjects = [
    ...
    {
      id: 2,
      title: 'Correlation Analysis Suite',
      description: 'Advanced statistical toolkit for discovering relationships between variables using Pearson, Spearman, and partial correlation methods.',
      image: 'https://images.unsplash.com/photo-1543286386-713bdd548da4?auto=format&fit=crop&w=1200&q=80',
      github: 'https://github.com/blue-jays/correlation-analysis',
      demo: null,
      tags: ['Correlation', 'Statistical Analysis', 'Data Relationships']
    },
    {
      id: 3,
      title: 'Confidence Interval Calculator',
      description: 'Precision estimation tool for calculating confidence intervals across various distributions with bootstrapping capabilities.',
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=80',
      github: 'https://github.com/blue-jays/confidence-intervals',
      demo: null,
      tags: ['Confidence Interval', 'Statistical Inference', 'Estimation']
    }
  ];

  return (
    <section id="statistical-analysis" className="py-20 bg-primary">
      <div className="container mx-auto px-4">
        ...
        >
          {statisticalProjects.map((project) => (
            <div 
              key={project.id}
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tags.map((tag, index) => (
                  <span 
                    key={index}
                    className="px-3 py-1 text-xs font-semibold rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white"
                  >
                    {tag}
                  </span>
                ))}
...
export default StatisticalDataAnalysis;
