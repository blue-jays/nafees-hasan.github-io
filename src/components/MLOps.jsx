  ...
  const mlopsProjects = [
    {
      ...
      github: 'https://github.com/blue-jays/mlops-pipeline',
      demo: null,
    ...
    },
    {
      ...
      github: 'https://github.com/blue-jays/ml-inference-system',
      demo: null,
    ...
    },
    {
      ...
      github: 'https://github.com/blue-jays/ml-model-registry',
      demo: null,
      tags: ['MLflow', 'Python', 'AWS', 'Automation']
    }
  ];

  return (
    <section id="mlops" className="py-20 bg-primary">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-300 mb-12 max-w-3xl mx-auto">
          Production-ready ML systems combining Software Engineering, Data Science, 
          Machine Learning, and MLOps best practices
        </p>
